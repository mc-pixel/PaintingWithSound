...
// ************************************************************************************
	...
	push();
		...
		for (int i = 0; i < gridTotal; ++i) {
			...
			float _aA = map(myAudioData[ myPickedAudio[i] ], 0, myAudioMax, 0.0f, 5.0f);
			_oscA.speed(_aA);
			_oscA.nextRaw(); 

			HOscillator _oscH = oscH[i];
			float _aH = map(myAudioData[ myPickedAudio[i] ], 0, myAudioMax, -0.1f, 10.0f);
			_oscH.speed(_aH);
			_oscH.nextRaw(); 
...
// ************************************************************************************
 ...
 public void buildCube(PImage _t1, float _w, float _h) {
	strokeWeight(0);
	noStroke();
