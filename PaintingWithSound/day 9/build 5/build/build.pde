...
// LOAD in a textureto match to a sprite
String texName = pathAssets + "rings.png";
PImage tex;
...
// ************************************************************************************
	...
	for (int i = 0; i < numAssets; ++i) {
		...
		tint(clrs.get( (int)waveMap,0),127);

		int sMap = (int)map(myAudioData[myPickedAudio[i]],0,myAudioMax,10,600);
