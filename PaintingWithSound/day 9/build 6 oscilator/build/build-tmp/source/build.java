...
// *********************************************************************************************
 ...
 public void setup() {
	...
	oscR = new HOscillator().range(-180, 180).speed(0.1f).freq(10).waveform(H.EASE);
	oscP = new HOscillator().range(1.1f, 4.0f).speed(1).freq(1).waveform(H.SINE);
	...
	oscRY = new HOscillator().range(-180, 180).speed(0.5f).freq(1).waveform(H.EASE);
	oscRZ = new HOscillator().range(-180, 180).speed(0.25f).freq(5).waveform(H.EASE);
}
...
// ************************************************************************************
	...
	perspective(PI/oscP.curr(), (float)(width*2)/(height/2),0.1f,1000000);
