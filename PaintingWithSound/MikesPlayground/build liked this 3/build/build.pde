...
String[] texNames = {"strasbourgM.png","strasbourgM.png","strasbourgM.png","strasbourgM.png","strasbourgM.png","vstrasbourgM.png"};
...
void setup() {
  ...
  for (int i = 0; i < texNamesLen; ++i) {
    ...
    pos[i] = layout.getNextPoint();
     ...
     oscZ[i]  = new HOscillator().range(-600, 300).speed(1).freq(2).currentStep(i*5).waveform(H.SINE);
