...
String      whichAudioFile = "bring_me_the_horizon_oh_no.mp3";
...
String      whichImg       = pathAssets + "colorsM_01.png";
PImage      clrs;
int         clrsW;
float       clrCount;
...
String[]    texNames       = { "particle_00.png" };
...
// ************************************************************************************
	...
	push();
		...
		for (int i = 0; i < numAssets; ++i) {
			...
			float _orbZ = map(myAudioData[ myPickedAudio[i] ], 0, myAudioMax, orbZ_SpeedMin, orbZ_SpeedMax);
