...
// ************************************************************************************
	...
	float _oscX = map(myAudioData[0], 0, myAudioMax, 0.1f, 2.0f);
	oscX.speed(_oscX);
	oscX.nextRaw();

	float _oscS = map(myAudioData[1], 0, myAudioMax, -0.5f, 2.0f);
	oscS.speed(_oscS);
	oscS.nextRaw();

	float _oscRX = map(myAudioData[2], 0, myAudioMax, 0.0f, 1.75f);
	oscRX.speed(_oscRX);
	oscRX.nextRaw();

	float _oscRY = map(myAudioData[4], 0, myAudioMax, 0.0f, 1.5f);
	oscRY.speed(_oscRY);
	oscRY.nextRaw();

	float _oscRZ = map(myAudioData[6], 0, myAudioMax, 0.0f, 1.25f);
	oscRZ.speed(_oscRZ);
	oscRZ.nextRaw();
