...
float myAudioIndex = 0.05;// this is the lowest starter number
float myAudioIndexAmp = myAudioIndex; //this is starter number + step //counting
float myAudioIndexStep = 0.025;// the number to gain by eacht time we move right
//themidibus
